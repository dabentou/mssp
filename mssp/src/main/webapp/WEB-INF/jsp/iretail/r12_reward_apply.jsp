...
<body>
    ...
    <div class="content"  align="center">
      	<form id="form" class="form-horizontal"  action="${ROOT}/iretail/project/apply/post" enctype="multipart/form-data" method="post" >
      		 <input  type="hidden"  class="input_style" name="type" value="R12" />
      		 <table class="maintable table table-hover">
      		 <tr><td colspan="5"><span class="project_title">门店零售奖励申请</span></td></tr>
					<tr>
     		 ...
     		 <tr>
     	 			...
     	 			<input  type="text"  class="input_style" name="applyTheme4" value="门店零售奖励" style="width:100px;" readonly/>
     	 		</td>
