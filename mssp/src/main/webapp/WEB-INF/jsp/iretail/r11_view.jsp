...
<body>
    ...
    <div class="content"  align="center">
      	<form id="myFrom" class="form-horizontal"  action="${ROOT}/iretail/project/flow"  method="post">
    		 ...
    		 <tr>
     		 ...
     		 <tr>
     		 	...
     		 	<td colspan="4">
     		 		<table id="tables">
     		 		<thead><tr> <td>下单人姓名</td> <td>商品名称</td> <td>商品数量</td> <td>商品单价</td>
     		 							 <td>产品积分</td> <td>订单积分</td> <td>下单时间</td> <td>订单状态</td><td>当月代理成本价</td>
     		 				</tr></thead>
	 ...
	 <c:if test="${check }">
	      	...
	      	<tr>
	      			<td colspan="2">核销发票真伪截图：</td>
	      			<td colspan="4"><img src ="${image.invoiceReal}" width="330"></img></td>
	      	</tr> 
	      	<tr>
	      			<td colspan="2">收货截图：</td>
	      			<td colspan="4"><img src ="${image.receiveImage}" width="330"></img></td>
	      	</tr> 
	      	<tr>
	      			<td colspan="2">签收单：</td>
	      			<td colspan="4"><img src ="${image.signIn}" width="330"></img></td>
	      	</tr> 
	...
	<form id="uploadForm" action="${ROOT}/iretail/project/upload" enctype="multipart/form-data" method="post" >
        	...
        	<c:if test="${isUploadVerificImg }">
	      		...
	      		<tr>
	      			<td colspan="2">上传收货截图：</td>
	      			<td colspan="4"><input type="file" id="receiveImage" name="files" /></td>
	      		</tr> 
	      		<tr>
...
$("#image").click(function(){
		...
		if($("#receiveImage").val()==null||$("#receiveImage").val()==""){
			alert("请上传收货截图");
			return false;
		}
