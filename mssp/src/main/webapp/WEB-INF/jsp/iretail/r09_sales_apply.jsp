...
<body>
    ...
    <%@include file="/WEB-INF/include/iretail_menu.jsp" %>
      	<form id="form" class="form-horizontal"  action="${ROOT}/iretail/project/apply/post" enctype="multipart/form-data" method="post" >
      		 <input  type="hidden"  class="input_style" name="type" value="R09" />
      		 <table class="maintable table table-hover"  style="width: 75%;">
      		 <tr><td colspan="5"><span class="project_title">终端用户促销申请</span></td></tr>
    		 <tr>
     		 ...
     		 <tr>
     	 			...
     	 			<input  type="text"  class="input_style" name="applyTheme4" value="终端用户促销" style="width:100px;" readonly/>
     	 		</td>
     		 	...
     		 	<td colspan="4">
     		 		<table>
     		 				<thead><tr> <td>促销型号</td> <td>计划销量（台）</td> <td>实际销量（台）</td> <td>赠品名称</td>
     		 							 <td>赠品单价</td> <td>赠品数量（份）</td> <td>赠品全额</td> <td>操作</td>
     		 				</tr></thead>
			...
			<input  type="submit" onclick="return valiForm();"  class="button button-lightblue" name="provider"  value="确认提交"/>
	</form>
  	</div>
  	</div>
</body>
