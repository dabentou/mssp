...
<div class="main-container">
   <div class="container-fluid">
      <ol class="breadcrumb">
        <li><a href="${ROOT}/admin/iretail/material/list.html">物料维护</a></li>
        <li>${isNew?"新增":"编辑" }</li>
      </ol>
      <div>
        <form id="form" class="form-horizontal" action="${ROOT}/admin/iretail/material/save" method="post">
          <div class="form-group">
          	<input type="hidden" value="${material.id }" name="id" />
            <label class="control-label">物料名称：</label>
            <div class="controls">
              <input type="text" class="form-control text" name="name" value="${material.name }" placeholder="物料名称" datatype="s1-18" />
            </div>
          </div>
          <div class="form-group">
            <div class="controls">
