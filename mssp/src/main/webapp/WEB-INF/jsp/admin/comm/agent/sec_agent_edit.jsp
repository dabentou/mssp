...
<div class="main-container">
   <div class="container-fluid">
      <ol class="breadcrumb">
        <li><a href="#">二级代理维护</a></li>
        <li>编辑</li>
      </ol>
      <div>
        <form id="form" class="form-horizontal" action="${ROOT}/admin/comm/scoagent/editSave" method="post">
          ...
          <div class="form-group">
            ...
            <div class="controls">
              <label class="radio-inline">
                <input type="radio" value=1 name="isUser" <c:if test="${commUser!=null }">checked</c:if> > 是
              </label>
              <label class="radio-inline">
                <input type="radio" value=0 name="isUser" <c:if test="${commUser==null }">checked</c:if>> 否
              </label>
            </div>
          </div>
          <div id="user" <c:if test="${commUser==null }">style="display:none;"</c:if>>
          	<div class="form-group">
	            <label class="control-label">登录名称：</label>
	            <div class="controls">
	              <input type="text" class="form-control text" name="loginName" value="${commUser.loginName }" placeholder="登录名称" />
	            </div>
	          </div>
	          <div class="form-group">
	            <label class="control-label">真实名称：</label>
	            <div class="controls">
	              <input type="text" class="form-control text" name="realName" value="${commUser.realName }" placeholder="真实名称" />
	            </div>
	          </div>
          </div>
