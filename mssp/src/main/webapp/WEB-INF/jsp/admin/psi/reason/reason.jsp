        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="operate-search">
                    <a href="${ROOT}/admin/psi/reason/new.html" class="button button-blue"><i class="icon icon11"></i>新增</a>
                </div>
                    ...
                    <table class="table table-hover mytable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="${ROOT}/admin/psi/reason/edit-${item.id}" class="operate operate1"><i></i>编辑</a><a href="#" onclick="deleteReason('${item.id}','${item.reason }')" class="operate operate2"><i></i>删除</a></td>
                            </tr>
                        </tbody>
                        </c:forEach>
                    </table>
...
function deleteReason(id,name){
	if(confirm("确定要删除"+name+"吗？")){
		 location.href = "${ROOT}/admin/psi/reason/delete?id="+id;
	};
}
</script>
</body>
